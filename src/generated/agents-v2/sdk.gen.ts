...
import type { ActivitiesGetData, ActivitiesGetResponses, ActivitiesGetErrors, ContextFilesGetData, ContextFilesGetResponses, ContextFilesGetErrors, UserMessagesAddData, UserMessagesAddResponses, UserMessagesAddErrors } from './types.gen';
...
export const contextFilesGet = <ThrowOnError extends boolean = false>(options: Options<ContextFilesGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ContextFilesGetResponses, ContextFilesGetErrors, ThrowOnError>({
        security: [
            {
                name: 'X-Asteroid-Agents-Api-Key',
                type: 'apiKey'
