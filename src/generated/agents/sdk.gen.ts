 ...
 */
export const deleteWorkflowCredentials = <ThrowOnError extends boolean = false>(options: Options<DeleteWorkflowCredentialsData, ThrowOnError>) => {
 ...
 */
export const getWorkflowCredentials = <ThrowOnError extends boolean = false>(options: Options<GetWorkflowCredentialsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetWorkflowCredentialsResponse, unknown, ThrowOnError>({
        url: '/workflow/{workflow_id}/credentials',
        ...options
    });
};
 ...
 */
export const addWorkflowCredential = <ThrowOnError extends boolean = false>(options: Options<AddWorkflowCredentialData, ThrowOnError>) => {
...
export const getCredentialsPublicKey = <ThrowOnError extends boolean = false>(options?: Options<GetCredentialsPublicKeyData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetCredentialsPublicKeyResponse, unknown, ThrowOnError>({
 ...
 */
export const getWorkflowVersions = <ThrowOnError extends boolean = false>(options: Options<GetWorkflowVersionsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetWorkflowVersionsResponse, unknown, ThrowOnError>({
 ...
 */
export const getExecutionUserMessages = <ThrowOnError extends boolean = false>(options: Options<GetExecutionUserMessagesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetExecutionUserMessagesResponse, unknown, ThrowOnError>({
 ...
 */
export const createExecutionUserMessage = <ThrowOnError extends boolean = false>(options: Options<CreateExecutionUserMessageData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>({
        url: '/execution/{id}/user_messages',
        ...options,
        headers: {
